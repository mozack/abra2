...
public class CadabraOptions extends Options {
	...
	protected OptionParser getOptionParser() {
    	if (parser == null) {
            ...
            parser.accepts(STRP_FILTER, "Filter variants with short tandem repeat period at or above this threshold(-1 to disable)").withRequiredArg().ofType(Integer.class).defaultsTo(6); 
            ...
            parser.accepts(FS_FILTER, "Filter variants with FS score greater than specified value").withRequiredArg().ofType(Integer.class).defaultsTo(30);
